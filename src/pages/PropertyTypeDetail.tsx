...
import { MapPin, Bed, Bath, Move, Calendar, Building2, CheckCircle } from 'lucide-react';
    ...
    return (
      ...
      >
        <div className="container mx-auto px-4 py-16 text-center">
          ...
          <Button asChild>
            <a href={`/properties/${propertyType.toLowerCase()}s`}>Return to {propertyType}s</a>
          </Button>
        </div>
      </PageLayout>
    );
              ...
              <div ref={introRef} className={introAnimation}>
                ...
                <div className="flex flex-wrap gap-6 mb-8">
                  ...
                  <div className="flex items-center">
                    ...
                    <span><strong>{property.property_type}</strong></span>
                  </div>
                  ...
                  <TabsContent value="location" className="pt-6">
                    ...
                    <div className="prose max-w-none">
                      ...
                      <ul className="list-disc pl-5 text-gray-700">
                        ...
                        <li>Public Beach (5 minutes)</li>
                        <li>Premium Schools (5-10 minutes)</li>
                        <li>Hospitals and Clinics (8 minutes)</li>
                      </ul>
                    </div>
                  </TabsContent>
                  
                  <TabsContent value="payment" className="pt-6">
                    {property.property_type.toLowerCase() === 'off-plan' ? (
                      <div>
